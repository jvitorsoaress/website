...
const translations: Record<Language, TranslationSet> = {
  'pt-BR': {
    ...
    'projects.common.meta': 'Open source · Biblioteca C#',
    'projects.common.description': 'Uma biblioteca C# reutilizável que simplifica padrões comuns de acesso a dados e reduz o código repetitivo de persistência.',
  ...
  en: {
    ...
    'projects.common.meta': 'Open source · C# library',
    'projects.common.description': 'A reusable C# library that simplifies common data-access patterns and reduces persistence boilerplate.',
